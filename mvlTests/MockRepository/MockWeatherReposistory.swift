...
class MockWeatherReposistory: MVLWeatherRepository {
    //MARK: - Web API
    var webAPIService: MVLWebAPIService = MockWebAPIService()

    //We use real local store service this cases
    //MARK: - Local store
    var localStoreService: MVLLocalStoreService = MVLLocalStoreServiceCoreDataImpl()
}

//MARK: - Web API - ReactiveX support
extension MockWeatherReposistory {
